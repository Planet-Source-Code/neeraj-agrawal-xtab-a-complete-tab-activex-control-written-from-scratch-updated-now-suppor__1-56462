...
Friend Function pWindowProc(ByVal lhWnd As Long, ByVal lMsg As Long, ByVal lwParam As Long, ByVal llParam As Long) As Long
  ...
  End If
  pWindowProc = CallWindowProc(m_lOrigWndProc, lhWnd, lMsg, lwParam, llParam)
End Function
...
#If ISDEBUG = 0 Then
  ...
  m_lOrigWndProc = SetWindowLong(hwnd, GWL_WNDPROC, AddressOf WndProc)
...
Private Sub pEndSubClass()
  ...
  SetWindowLong m_lhWndOrigSubClassed, GWL_WNDPROC, m_lOrigWndProc
